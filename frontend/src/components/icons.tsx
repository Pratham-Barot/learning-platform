...
export function SparklesIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="m12 3-1.9 5.8H4.5l4.8 3.5-1.9 5.8L12 14.6l4.6 3.5-1.9-5.8 4.8-3.5h-5.6L12 3z" />
    </svg>
  );
}
...
export function HistoryIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M3 3v5h5" />
      <path d="M3.05 13A9 9 0 1 0 6.5 6.5L3 8" />
      <path d="M12 7v5l4 2" />
    </svg>
  );
}

export function sourceIcon(type: string, className?: string) {
  switch (type) {
    case "youtube":
